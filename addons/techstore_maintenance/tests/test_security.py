...
class TestTechStoreSecurity(TransactionCase):
    ...
    def test_05_admin_full_crud(self):
        """SE-06: Admin puede crear, leer, actualizar y eliminar registros (CRUD total)."""
        ...
        self.assertTrue(maint.exists(), "Admin debe poder CREAR mantenimientos.")
        self.assertEqual(maint.description, 'Admin CRUD test', "Admin debe poder LEER mantenimientos.")
        maint.write({'description': 'Editado por Admin'})
        self.assertEqual(maint.description, 'Editado por Admin', "Admin debe poder ACTUALIZAR mantenimientos.")
        maint.unlink()
        self.assertFalse(maint.exists(), "Admin debe poder ELIMINAR mantenimientos.")
